...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void dataToWatch(){
        ...
        dataMap.putString(WATCH_TEMP_HIGH, Utility.formatTemperature(context, cursor.getDouble(INDEX_MAX_TEMP)));
        dataMap.putString(WATCH_TEMP_LOW, Utility.formatTemperature(context, cursor.getDouble(INDEX_MIN_TEMP)));
